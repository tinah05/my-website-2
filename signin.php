...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>FBS &mdash; Register </title>
  ...
  <body>
        ...
        <div class="container">
          ...
          <!-- Content Area -->
          <hr/>
          <h5 class="site-section-heading font-weight-light text-danger text-center" style="font-size:2.2rem;"><strong> Sign In</strong></h5>
          

          <div class="row justify-content-center">
            <div class="col-md-7">
              <form method="post" action="signin.php" class="p-5 bg-white">
                ...
                <div class="row form-group">
                  <div class="col-md-12 text-center">
                    <p> <em> By signing into your account, you agree to our <a href="#" class="text-danger">Terms &amp; Privacy</a>. </em> </p>
                  </div>
                </div>

                <div class="row form-group">
                  <div class="col-md-12">
                    <input type="submit" name="login_user" value="Sign In" class="btn btn-danger btn-block py-2 px-4 text-white">
                    <p> <em> Don't have an account? <a href="signup.php" class="text-danger">Sign Up</a> </em> </p>
                  </div>
                </div>
              </form>
            </div>
          ...
          <div class="row justify-content-center mb-2">
            <div class="col-md-12"><br/>
              ...
              <p class="text-center">
                <strong>
                  <a href="register.html" class="btn btn-danger px-4 py-2 text-white" style="border-radius:25px;"> Sign In Now </a> <br/>
                  <a href="index.html" class="text-danger">HOME</a> |
                  <a href="aboutus.html" class="text-danger">ABOUT US</a> |
                  <a href="services.html" class="text-danger">SERVICES</a> |
                  <a href="signup.php" class="text-danger">SIGN UP</a> |
